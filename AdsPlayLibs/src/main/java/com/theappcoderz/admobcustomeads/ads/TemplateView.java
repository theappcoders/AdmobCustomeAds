...
import com.theappcoderz.admobcustomeads.R;import com.theappcoderz.admobcustomeads.ads.NativeTemplateStyle;
...
public class TemplateView extends FrameLayout {
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.gnt_medium_template_origin) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.gnt_medium_template_origin);
        } finally {
            attributes.recycle();
        }
